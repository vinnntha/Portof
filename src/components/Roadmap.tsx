...
export function Roadmap() {
  ...
  return (
    <section
      ref={sectionRef}
      id="roadmap"
      className="relative py-12 md:py-28 bg-[#050810] overflow-hidden px-4 sm:px-6 md:px-12 border-b border-ice-300/5"
    >
      ...
      <div className="relative z-10 max-w-7xl mx-auto flex flex-col space-y-8 md:space-y-16">
        ...
        <div>
          ...
          <p className="text-ice-300 font-sans text-xs sm:text-sm mt-2">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-6 md:gap-8 relative">
          ...
          {phases.map((phase, index) => (
            ...
            >
              <div className="glass-card p-5 sm:p-8 rounded-2xl border border-ice-300/10 flex flex-col justify-between h-full relative group">
                
                {/* Glowing Dot Marker for Mobile */}
                <div className="lg:hidden absolute left-[-31px] top-6 sm:top-9 h-4.5 w-4.5 rounded-full border-4 border-[#050810] bg-ice-300 shadow-[0_0_8px_rgba(125,211,252,0.5)] z-20" />
                ...
                <div className="space-y-4 md:space-y-6">
                  ...
                  <div className="flex items-center justify-between">
                    ...
                    <span className="text-3xl sm:text-4xl font-extrabold font-syne text-ice-300/15 select-none">
                      {phase.num}
                    </span>
                  </div>
                  ...
                  {/* Titles */}
                  <div>
                    <h3 className="text-xl sm:text-2xl font-bold font-syne text-ice-100 group-hover:text-ice-300 transition-colors duration-300">
                      {phase.title}
                    </h3>
                    <p className="text-[10px] sm:text-xs font-mono text-ice-400 mt-1 uppercase tracking-widest">
                      {phase.subtitle}
                    </p>
                  </div>
                  ...
                  <ul className="space-y-2.5 sm:space-y-3 pt-1 sm:pt-2">
                    {phase.bullets.map((bullet) => (
                      <li key={bullet} className="flex items-start gap-2.5 text-xs sm:text-sm text-ice-300 font-sans">
