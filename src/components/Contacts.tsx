            ...
            <div className="space-y-4 pt-10 border-t border-ice-300/10">
              ...
              <div className="flex gap-4">
                {[
                  {
                    name: "GitHub",
                    href: "https://github.com/vinnntha",
                    icon: (
                  ...
                  {
                    name: "LinkedIn",
                    href: "https://www.linkedin.com/in/averill-kevinatha-20127a417?utm_source=share_via&utm_content=profile&utm_medium=member_ios",
                    icon: (
                      <svg className="h-4.5 w-4.5" fill="currentColor" viewBox="0 0 24 24">
                  ...
                  {
                    name: "Instagram",
                    href: "https://instagram.com/vinn.ntha",
                    icon: (
                      <svg className="h-4.5 w-4.5" fill="currentColor" viewBox="0 0 24 24">
